...
let data2 = Buffer.from('<34>1 2003-10-11T22:14:15.003Z mymachine.example.com su - ID47 - su root failed for lönvick on /dev/pts/8\n', 'utf8'); 
...
let sampleData  = Buffer.from('<165>1 2003-10-11T22:14:15.003Z mymachine.example.comevntslog - ID47 [exampleSDID@32473 iut="3" eventSource="Äpplication" eventID="1011"] BOMAn Äpplication event log entry...\n','utf8');

function commit(){
    console.log('BEFORE Data BUFFER Len ', Buffer.byteLength(data))
